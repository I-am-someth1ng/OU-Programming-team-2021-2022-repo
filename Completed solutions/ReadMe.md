This folder is for completed solutions to problems we work on during meetings (you must be able to pass all tests on whatever platform the problem is on).
